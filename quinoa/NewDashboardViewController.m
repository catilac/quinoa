...
- (void)updatePhysicalChart {
    ...
    PNCircleChart * circleChart = [[PNCircleChart alloc] initWithFrame:CGRectMake(25, 10, 60, 60) andTotal:[NSNumber numberWithInt:100] andCurrent:[NSNumber numberWithInt:(achieved * 100)] andClockwise:NO andShadow:YES];
    circleChart.labelColor = [UIColor whiteColor];
